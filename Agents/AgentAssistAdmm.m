classdef AgentAssistAdmm < AgentBase 
...
%         obsModel = HumanReactionModel(); % observation model
    ...
    methods 
        function obj = AgentAssistAdmm(dt_input,horizonSteps, node_idx, belief_dyns)
            obj@AgentBase();  
            ...
            obj.cst_primal = @(D,idx,b,u,lam_di,lam_up,lam_w,i) beliefDynCost_assist_primal...
                (D,idx,b,u,lam_di,lam_up,lam_w,obj.rho_d,obj.rho_up,horizonSteps,false,...
                obj.motionModel,obj.obsModel, belief_dyns, svc);

            obj.cst_primal_diff = @(D,idx,b,u,c_bi,c_ui,...
                c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj,lam_di,lam_up,lam_w)cst_assist_primal_diff...
                (D,idx,b,u,c_bi,c_ui,...
                c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj,lam_di,lam_up,lam_w,obj.rho_d,obj.rho_up);
            obj.lambda = []; 
            obj.dlambda = [];
            obj.flgChange = [];
        end
...
%         end
        function [x, u, cost, L, Vx, Vxx, finished]= ...
                iLQG_one_it...
                (obj,D, b0, Op, iter, u_guess, lam_di,lam_up,lam_w,...
