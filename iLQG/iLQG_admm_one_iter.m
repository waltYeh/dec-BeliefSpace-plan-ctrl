function [x, u,L, Vx, Vxx, cost,  ...
    ...
    u_guess,lam,lambda_last, dlambda_last, ...
...
%     enlonged_uC_lambda = uC_lambda;
    ...
    [c_bi,c_ui,c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj] ...
        ...
        c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj,lam);
...
%         uC_lambda_new{i}(:,:,k) = uC_lambda{i}(:,k*K1);
    ...
    for i=1:n_agent-2
        lam_d_new(i,:,:,k) = lam.lam_d(i,:,k*K1);
%         lam_b_new(i,:,:,k) = lam.lam_b(i,:,k*K1);
%         uC_lambda_new{i}(:,:,k) = uC_lambda{i}(:,k*K1);
    end
