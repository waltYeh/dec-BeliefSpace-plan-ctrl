function b_next = beliefDynamics_infoFilter(b, u, motionModel, obsModel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:horizon    
    b_next(:,i) = updateSingleBelief_infoFilter(b(:,i), u(:,i), motionModel, obsModel);
end


end

function b_next = updateSingleBelief_infoFilter(b, u, motionModel, obsModel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
