...
%         obsModel = HumanReactionModel(); % observation model
    ...
    methods 
        function obj = AgentAssistAdmm(dt_input,horizonSteps, node_idx, belief_dyns)
            ...
            obj.cst_primal = @(D,idx,b,u,rho,uC_lambda,i) beliefDynCost_crane_primal...
            ...
            obj.cst_primal_diff = @(D,idx,b,u,c_bi,c_ui,...
                c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj,lam_di,lam_up)cst_assist_primal_diff...
                (D,idx,x,u,c_bi,c_ui,...
...
%         end
        function [x, u, cost, L, Vx, Vxx, finished]= ...
            ...
            [x, u, L, Vx, Vxx, cost, obj.lambda, obj.dlambda, finished,...
                ...
                b0, Op, iter,u_guess,...
                lam_di,lam_up,obj.rho_d,obj.rho_up,...
