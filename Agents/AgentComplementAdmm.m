...
%         obsModel = HumanReactionModel(); % observation model
    ...
    methods 
        function obj = AgentComplementAdmm(dt_input,horizonSteps, node_idx, belief_dyns)
            ...
            obj.cst_primal = @(D,idx,b,u,lam_di,lam_b,lam_up,lam_w,i) beliefDynCost_compl_primal...
            ...
            obj.cst_primal_diff = @(D,idx,b,u,c_bi,c_ui,...
                c_bi_bi,c_bi_ui,c_ui_ui,c_ui_uj,lam_di,lam_b,lam_up,lam_w)cst_compl_primal_diff...
                (D,idx,b,u,c_bi,c_ui,...
